...
// --- Inputs ---
    ...
    // Object 2: Right Wall
        uniform vec3 right_wall_point;
        uniform vec3 right_wall_normal;
        uniform vec3 right_wall_ambientReflection;
        uniform vec3 right_wall_diffuseReflection;
        uniform vec3 right_wall_specularReflection;
        uniform float right_wall_shininess;

    // Object 3: Front Wall
        uniform vec3 front_wall_point;
        uniform vec3 front_wall_normal;
        uniform vec3 front_wall_ambientReflection;
        uniform vec3 front_wall_diffuseReflection;
        uniform vec3 front_wall_specularReflection;
        uniform float front_wall_shininess;

    // Object 4: Left Wall
        uniform vec3 left_wall_point;
        uniform vec3 left_wall_normal;
        uniform vec3 left_wall_ambientReflection;
        uniform vec3 left_wall_diffuseReflection;
        uniform vec3 left_wall_specularReflection;
        uniform float left_wall_shininess;

    // Object 5: Roof
        uniform vec3 roof_point;
        uniform vec3 roof_normal;
        uniform vec3 roof_ambientReflection;
        uniform vec3 roof_diffuseReflection;
        uniform vec3 roof_specularReflection;
        uniform float roof_shininess;
    ...
    void main() {
        ...
        // --- Right Wall ---
            objects[1] = CreatePlane(
                1,
                Plane(right_wall_point, right_wall_normal),
                Material(right_wall_ambientReflection, right_wall_diffuseReflection, right_wall_specularReflection, right_wall_shininess)
            );

        // --- Front Wall ---
            objects[2] = CreatePlane(
                2,
                Plane(front_wall_point, front_wall_normal),
                Material(front_wall_ambientReflection, front_wall_diffuseReflection, front_wall_specularReflection, front_wall_shininess)
            );

        // --- Left Wall ---
            objects[3] = CreatePlane(
                3,
                Plane(left_wall_point, left_wall_normal),
                Material(left_wall_ambientReflection, left_wall_diffuseReflection, left_wall_specularReflection, left_wall_shininess)
            );

        // --- Roof ---
            objects[4] = CreatePlane(
                4,
                Plane(roof_point, roof_normal),
                Material(roof_ambientReflection, roof_diffuseReflection, roof_specularReflection, roof_shininess)
            );

        // --- Cilinder ---
            objects[5] = CreateCilinder(
                5,
        ...
        // --- Cone ---
            objects[6] = CreateCone(
                6,
                Cone(cone_baseCenter, cone_baseRadius, cone_height, cone_direction),
